function Blast(_geometry, _color, _size, _callback, _callbackscope) {
	...
	this.material 		= 	this.material = new THREE.PointCloudMaterial({
		...
		map : THREE.ImageUtils.loadTexture('examples/textures/transition/transition1.png'),
...
Blast.prototype.animateParticles 	= function(p_delta) {
	...
	for (var i = 0; i < vertices.length; i++) {
		...
		if (this.material.color.r > 0) {
			...
			this.material.color.r -= decay * p_delta;
		}else {
